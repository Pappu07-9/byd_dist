        ...
        <div className="container">
            <div className="inside-byd">
                ...
                {showProduct ? (
                    ...
                    //     </div>
                    // </div>
                    <Flex w='100%' justifyContent={"flex-end"} pr={'20vw'} overflow={'hidden'}>
                        <Flex flexDirection='column' gap='40px' alignItems={'center'}>

                            <NavLink to={'/products'}>
                                <Text textColor={'white'} fontWeight='600' fontSize={'26px'}
                            ...
                            <Text textColor={'white'} fontWeight='600' fontSize={'26px'} transition={'ease-in-out 0.3s'}
                                _hover={{
                                    fontSize: '30px'
                            ...
                            <Text textColor={'white'} fontWeight='600' fontSize={'26px'}
                                ...
                                _hover={{
                                    fontSize: '30px',
                                    // pr: '20px'
                                }}>Evaluation & Exchange </Text>
                            <NavLink to={'/cost-saving'}>
                                <Text textColor={'white'} fontWeight='600' fontSize={'26px'} transition={'ease-in-out 0.3s'}
                                    _hover={{
                                        fontSize: '30px'
                                    }}>Cost Saving</Text>
